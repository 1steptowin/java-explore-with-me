...
CREATE TABLE IF NOT EXISTS feature_locations ( location_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, name VARCHAR(500), latitude DOUBLE PRECISION, longitude DOUBLE PRECISION, radius DOUBLE PRECISION, CONSTRAINT pk_feature_locations PRIMARY KEY(location_id) );

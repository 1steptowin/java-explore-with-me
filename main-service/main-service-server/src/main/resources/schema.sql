...
CREATE TABLE IF NOT EXISTS locations ( location_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, name VARCHAR(100), longitude FLOAT, latitude FLOAT, radius FLOAT, CONSTRAINT pk_locations PRIMARY KEY(location_id) );

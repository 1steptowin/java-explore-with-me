...
CREATE TABLE IF NOT EXISTS event_locations ( location_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL, latitude FLOAT, longitude FLOAT, CONSTRAINT pk_locations PRIMARY KEY(location_id) );
